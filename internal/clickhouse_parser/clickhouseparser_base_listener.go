...
// EnterAlterTableClauseClear is called when production AlterTableClauseClear is entered.
func (s *BaseClickHouseParserListener) EnterAlterTableClauseClear(ctx *AlterTableClauseClearContext) {
}

// ExitAlterTableClauseClear is called when production AlterTableClauseClear is exited.
func (s *BaseClickHouseParserListener) ExitAlterTableClauseClear(ctx *AlterTableClauseClearContext) {}
