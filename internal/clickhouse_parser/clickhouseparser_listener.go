...
type ClickHouseParserListener interface {
	...
	// EnterAlterTableClauseClear is called when entering the AlterTableClauseClear production.
	EnterAlterTableClauseClear(c *AlterTableClauseClearContext)
	...
	// ExitAlterTableClauseClear is called when exiting the AlterTableClauseClear production.
	ExitAlterTableClauseClear(c *AlterTableClauseClearContext)
